        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {/* Arrival */}
              <div className="flex flex-row items-start gap-4 md:flex-col md:items-center md:gap-8">
                {/* Dot for mobile/desktop */}
                <div className="flex flex-col items-center z-10">
                  <div className="w-4 h-4 bg-[var(--red)] rounded-full border-4 border-white shadow-lg"></div>
                  <div className="flex-1 w-1 bg-gray-200 hidden md:block"></div>
                </div>
                <div className="flex-1 md:w-1/2 md:text-right w-full pl-2 md:pl-0">
                  <Card className="border-l-4 border-l-[var(--red)] shadow-lg">
                    <CardHeader>
                      <div className="flex items-center gap-3 md:justify-end justify-start">
                        <CardTitle className="text-xl font-bold order-1 md:order-none">
                          Arrival & Registration
                        </CardTitle>
                        <div className="w-12 h-12 bg-[var(--red)]/10 rounded-full flex items-center justify-center order-2 md:order-none">
                          <UserPlus className="w-6 h-6 text-[var(--red)]" />
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-600 text-left md:text-right">
                        Check in, get your swag, and enjoy breakfast while
              ...
              <div className="flex flex-row items-start gap-4 md:flex-col md:items-center md:gap-8">
                <div className="flex flex-col items-center z-10">
                  <div className="w-4 h-4 bg-[var(--apple)] rounded-full border-4 border-white shadow-lg"></div>
                  <div className="flex-1 w-1 bg-gray-200 hidden md:block"></div>
                </div>
                <div className="flex-1 md:w-1/2 md:order-2 pl-2 md:pl-0">
                  <Card className="border-l-4 border-l-[var(--apple)] shadow-lg">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Engaging discussions on education perspectives and
                        technology trends with industry experts.
                      </p>
              ...
              <div className="flex flex-row items-start gap-4 md:flex-col md:items-center md:gap-8">
                <div className="flex flex-col items-center z-10">
                  <div className="w-4 h-4 bg-[var(--gnTeal)] rounded-full border-4 border-white shadow-lg"></div>
                  <div className="flex-1 w-1 bg-gray-200 hidden md:block"></div>
                </div>
                <div className="flex-1 md:w-1/2 md:text-right pl-2 md:pl-0">
              ...
              <div className="flex flex-row items-start gap-4 md:flex-col md:items-center md:gap-8">
                <div className="flex flex-col items-center z-10">
                  <div className="w-4 h-4 bg-[var(--canary)] rounded-full border-4 border-white shadow-lg"></div>
                  <div className="flex-1 w-1 bg-gray-200 hidden md:block"></div>
                </div>
                <div className="flex-1 md:w-1/2 pl-2 md:pl-0">
                  <Card className="border-l-4 border-l-[var(--canary)] shadow-lg">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Build your project with support from technical and
                        education mentors.
                      </p>
              ...
              <div className="flex flex-row items-start gap-4 md:flex-col md:items-center md:gap-8">
                <div className="flex flex-col items-center z-10">
                  <div className="w-4 h-4 bg-[var(--seafoam)] rounded-full border-4 border-white shadow-lg"></div>
                </div>
                <div className="flex-1 md:w-1/2 md:text-right pl-2 md:pl-0">
                  <Card className="border-l-4 border-l-[var(--seafoam)] shadow-lg">
                    ...
                    <CardContent>
                      <p className="text-gray-600">
                        Learn pitching techniques and showcase your work in
