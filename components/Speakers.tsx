            ...
            <Card className="bg-gradient-to-br from-[var(--seafoam)]/5 to-[var(--seafoam)]/10 border-none shadow-lg aspect-square">
              <CardHeader>
                <div className="flex flex-col items-start gap-4">
                  ...
                  <CardTitle className="text-xl font-bold">Speaker 1</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-left">
                  Senior Software Engineer at TechCorp, specializing in AI and
                  Machine Learning
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-[var(--seafoam)]/5 to-[var(--seafoam)]/10 border-none shadow-lg aspect-square">
              <CardHeader>
                <div className="flex flex-col items-start gap-4">
                  ...
                  <CardTitle className="text-xl font-bold">Speaker 2</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-left">
            ...
            <Card className="bg-gradient-to-br from-[var(--seafoam)]/5 to-[var(--seafoam)]/10 border-none shadow-lg aspect-square">
              <CardHeader>
                <div className="flex flex-col items-start gap-4">
                  ...
                  <CardTitle className="text-xl font-bold">Speaker 3</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-left">
